...
Cases (from ~/dvo-cache/authored/ttsr-scope-2026-08-20.md):
  ...
  4 aborted attempts' tokens reach _usage → the #114 cost cap trips on them
...
check("_usage is the transport's eval_count", msg["_usage"] == 9)
...
check("_usage = retry eval_count + aborted estimate", msg["_usage"] == 7 + est)
